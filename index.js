...
break
case prefix+'profil':{
var text1 = `Hallo ${sender.split("@")[0]}`
var text2 = `Welcome To ${setting.botName}`
var text3 = `Total User : ${pendaftar.length}`
var avatar_nya = `https://cdn.discordapp.com/embed/avatars/0.png`
let media =`https://api.popcat.xyz/welcomecard?background=https://cdn.discordapp.com/attachments/850808002545319957/859359637106065408/bg.png&text1=${text1}&text2=${text2}&text3=${text3}&avatar=${avatar_nya}`
lexxy.sendMessage(from, { image: { url: media }, caption: 'done!!'}, {quoted:msg})
}
break
case prefix+'smeme':
